...
const Header_1 = ({ name, img }) => {
    ...
    return (
        <div className=' sticky top-0 z-[100] '>
            <div className='flex items-center justify-center w-screen h-20 overflow-hidden bg-white '>
                <div className='flex items-center justify-between w-full h-full mx-20 border-b-2  border-black/20' >
                    ...
                    <div className='flex items-center justify-center w-auto h-auto rounded-none  bg-slate-200/0'>
                        <div className='w-auto h-auto px-3 py-2 rounded-full  bg-slate-000' >
