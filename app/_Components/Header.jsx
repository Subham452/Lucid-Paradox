...
const Header = ({ name, img }) => {
    ...
    // alert(name2)
    return (
        <div className={`sticky top-0 z-[100] h-auto w-screen ${active?"":"overflow-hidden delay-200"} `}>
            <div className='flex flex-col items-center justify-between w-screen h-20 px-20 overflow-hidden bg-white '>
                <div className='flex items-center justify-between w-full h-full bg-white '>
                    ...
                    <div className='flex flex-row items-center justify-between gap-8 '>
                        ...
                        {/* <div className='flex items-center justify-center w-auto h-auto p-3 bg-black ' onClick={() => { alert(aa); setActive(!active) }}> */}
                        <div className='flex items-center justify-center w-auto h-auto p-3 bg-black ' onClick={() => { alert(aa); setActive(!active) }}>
                ...
                <div className={`absolute ${active ? "" : " opacity-0 -right-96 -mt-96 "} transition-all duration-[1500ms] right-0 bg-white shadow-lg rounded-bl-2xl top-20 h-96 w-auto lg:w-96 `}>
